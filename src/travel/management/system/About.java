...
public class About extends JFrame implements ActionListener {
    ...
    About() {
        ...
        " \n" +
        "The objective of the Travel and Tourism Management Systemproject is to develop a system that automates the processes and activites of a travel and the purpose is to design a system using which one can perform all operations related to taveling\n"+
        "\n" +
